...
RST_SYNC # (.NUM_STAGES(2)) U0_RST_SYNC1 (
.RST(RST_N),
.CLK(UART_CLK),
.SYNC_RST(SYNC_UART_RST)
);

RST_SYNC # (.NUM_STAGES(2)) U0_RST_SYNC2 (
.RST(RST_N),
.CLK(REF_CLK),
...
.RST(SYNC_REF_RST),
.SC_RdData(RF_RdData),
.SC_RdData_VLD(RF_RdData_VLD),
.SC_WrEn(RF_WrEn),
.SC_RdEn(RF_RdEn),
.SC_Address(RF_Address),
.SC_WrData(RF_WrData),
.ALU_EN(ALU_EN),
.ALU_FUN(ALU_FUN), 
.ALU_OUT(ALU_OUT),
